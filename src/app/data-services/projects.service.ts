...
export class ProjectsService {
  ...
  projectsVideo: BriefProjectCards =[ {
   ...
   link: '../../assets/gif/OnlineStore.gif',

  },
  {id: 'spacegame',
    title:  "Space Expatriate Game",
    skills: ['Typescript', 'React', 'MobX'],
    link: '../../assets/gif/SpaceGame.gif',
  },
  {   id: 'designerportfolio',
    title:   'UI/UX Designer Portfolio',
    skills: ['Typescript', 'React', 'Figma'],
    link: '../../assets/gif/WebPortfolio.gif',
  },
  { id: 'languagecards',
    title:  "Language Cards",
    skills: ['Javascript', 'React', 'Redux'],
    link: '../../assets/gif/LL.gif',
  },
  {  id: 'myportfolio',
    title:   "My First Portfolio",
    skills: ['Javascript', 'React'],
    link: '../../assets/gif/MyFirstPortfolio.gif',
  },
 
  { id: 'todo',
    title:  "Todo",
    skills: ['Typescript', 'React', 'Redux'],
    link: '../../assets/gif/Todo.gif',
  },
]
